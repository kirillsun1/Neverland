...
class NLConfirmationPopupService {
    ...
    func presentPopup(forQuest quest: Quest, into viewController: UIViewController) {
        let popup = PopupDialog(title: "TAKE QUEST", message: "Do you want to take Quest: \(quest.title)", image: nil)
