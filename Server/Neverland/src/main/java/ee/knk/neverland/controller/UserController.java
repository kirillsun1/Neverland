...
public class UserController {
    ...
    public String register(@RequestParam(value="username") String username, @RequestParam(value="password") String password, @RequestParam(value="email") String email,
        ...
        return gson.toJson(new RegistrationLoginAnswer(RegistrationLoginConstants.SUCCEED, tokenController.addKey(user)));
    }
    ...
    public String login(@RequestParam(value="username") String username, @RequestParam(value="password") String password) {
        ...
        return gson.toJson(new RegistrationLoginAnswer(RegistrationLoginConstants.SUCCEED, token));
    }
