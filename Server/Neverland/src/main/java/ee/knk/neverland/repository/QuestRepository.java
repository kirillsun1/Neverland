...
public interface QuestRepository extends JpaRepository<Quest, Long> {
    @Query("SELECT quest FROM Quest quest WHERE quest.user = :author AND quest.peopleGroup = null ORDER BY quest.id ASC")
    ...
    @Query("SELECT quest FROM Quest quest WHERE quest.peopleGroup = null ORDER BY quest.id ASC")
